 ...
 */
public class PublishToAnalyticsFunctionImplNew extends AbstractAnalyticsFunction implements PublishToAnalyticsFunction {
    ...
    public void publishToAnalytics(Map<String, String> metadata, Map<String, Object> payloadData,
        ...
        try {
                ...
                client.execute(targetHost, request, new FutureCallback<HttpResponse>() {
                    ...
                    public void completed(final HttpResponse response) {
                        ...
                        if (responseCode == 200) {
                            ...
                            LOG.info("Error while publishing data to analytics engine for session data key: " +
                    ...
                    public void failed(final Exception ex) {
                        ...
                        LOG.debug("Error while publishing data to analytics engine for session data key: " +
            ...
            LOG.debug("Error while calling analytics engine for tenant: " + context.getWrapped().getTenantDomain(), e);
        } catch (IdentityEventException e) {
            LOG.error("Error while preparing authentication information for tenant: " + context.getWrapped()
                    .getTenantDomain(), e);
        } catch (FrameworkException e) {
            LOG.warn("Error while building client to invoke analytics engine for tenant: " + context.getWrapped()
                    .getTenantDomain(), e);
        }
    }
}
